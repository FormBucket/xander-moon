      ...
      <Layout>
        ...
        <div className="wrapper">
          <div className="signup-form">
            ...
            <h2>Free for 14 days. No credit card required.</h2>
            ...
            <label htmlFor="createPassword">
              <FontAwesome name="lock" /> Create Password
            </label>
            <input
              onKeyUp={this.handleKeyUp}
              type="password"
            ...
            <p className="muted">
              ...
              and also agree to receive news and tips via email.
            </p>
          </div>
          <div className="signup-benefits">
            <div id="pricing" className="wrapper">
              <div className="plan">
                <h3>
                  $7<span className="month">/mo</span>
                </h3>
