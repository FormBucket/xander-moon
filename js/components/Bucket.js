...
class NewBucket extends React.Component {
  ...
  componentDidMount() {
    ...
    Promise.all([requestBucket(this.props.router.params.id), requestProfile()])
      .then(([bucket, user]) => {
        setTimeout(() => dispatch("loadBucket", bucket), 0);
  ...
  onDownload = bucket => {
    requestBucketExport(bucket.id).then(result => requestDownloadFile(result));
  };

  onDownloadCSV = bucket => {
    requestBucketExport(bucket.id, "csv").then(result =>
  ...
  render() {
    ...
    let savedBucket = this.props.buckets.buckets.filter(
      d => d.id === this.props.bucket.id
    )[0];
        ...
        <div className="wrapper">
          <div className="bucket-details">
            <div className="section">
              ...
              />
              <label htmlFor="bucketEnabled" className="label-switch">
                {" "}
                Accept Submissions?
                <input
                  id="bucketEnabled"
                  type="checkbox"
                  onClick={event => setState({ enabled: event.target.checked })}
            ...
            <div className="section">
              ...
              <label htmlFor="bucketAJAXOnly" className="label-switch">
                ...
                <input
                  ...
                  type="checkbox"
                  onChange={event =>
                    setState({ is_api_request: event.target.checked })
                  }
            ...
            <div className="section">
              ...
              <label>
                <input
                  type="radio"
                  onChange={() => setState({ email_to: false })}
              ...
              <label>
                <input
                  type="radio"
                  onClick={() => setState({ email_to: true })}
              ...
              <label>
                ...
                <textarea
                  ...
                  onChange={e => setState({ email_to: e.target.value })}
                  defaultValue={
              ...
              <div
                className="autoresponder-wrapper"
                style={{
              ...
              >
                ...
                <input
                  ...
                  onChange={e =>
                    setState({ notification_from: e.target.value })
                  }
                ...
                <input
                  ...
                  onChange={e =>
                    setState({ notification_reply_to: e.target.value })
                  }
                ...
                <textarea
                  ...
                  ref="auto_responder_body"
                  placeholder="Send default notification"
                  onChange={e =>
                    setState({ notification_template: e.target.value })
                  }
            ...
            <div className="section">
              ...
              <label>
                <input
                  type="checkbox"
                  className="checkbox autoresponder"
            ...
            <div className="section">
              ...
              <label htmlFor="honeyPotEnabled" className="label-switch">
                ...
                <input
                  ...
                  type="checkbox"
                  onClick={event =>
                    setState({ honey_pot_on: event.target.checked })
                  }
              ...
              {IF(
                ...
                <div>
                  <label>
                    Honey pot field{" "}
                    <a className="pull-right" href="/guides/honeypot">
                      Honey pot?
                    </a>
                    <input
                      placeholder="Optional custom fieldname"
                      onChange={e =>
                        setState({ honey_pot_field: e.target.value })
                      }
              ...
              <label htmlFor="recaptchaEnabled" className="label-switch">
                {" "}
                Recaptcha
                <input
                  id="recaptchaEnabled"
                  type="checkbox"
                  onClick={event =>
                    setState({ recaptcha_on: event.target.checked })
                  }
              ...
              {IF(
                ...
                <div className="spam-protection">
                  <label>
                    ...
                    <input
                      onChange={e =>
                        setState({ recaptcha_secret: e.target.value })
                      }
            ...
            <div className="bucket-editor">
              ...
              <div>
                {IF(
                  ...
                  null,
                  <div
                    dangerouslySetInnerHTML={{ __html: makeHTMLForm(bucket) }}
                  />
                )}
              </div>
            </div>
          ...
          <div className="bucket-preview">
            <p>
              <a
                href="javascript:void(0)"
                onClick={() => this.onDownloadCSV(bucket)}
              >
            ...
            <p>
              <a
                href="javascript:void(0)"
                onClick={() => this.onDownload(bucket)}
              >
