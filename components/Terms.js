...
let Terms = () => (
  <Guide title="Terms of Service" title2="">
    <div>
      <span>
        <p>
          Please read these Terms of Service ("Terms", "Terms of Service")
          carefully before using the https://formbucket.com website (the
          "Service") operated by FormBucket.com ("us", "we", or "our").
        </p>
        <p>
        ...
        <p>
          ...
          that are not owned or controlled by FormBucket.com.
        </p>
        <p>
          FormBucket.com has no control over, and assumes no responsibility for
          the content, privacy policies, or practices of any third party web
          sites or services. We do not warrant the offerings of any of these
          entities/individuals or their websites.
        </p>
        <p>
          You acknowledge and agree that FormBucket.com shall not be responsible
        ...
        <p>
          We spanly advise you to read the terms and conditions and privacy
        ...
        <p>
          You agree to defend, indemnify and hold harmless FormBucket.com and
        ...
        <p>
          In no event shall FormBucket.com, nor its directors, employees,
        ...
        <p>
          FormBucket.com its subsidiaries, affiliates, and its licensors do not
