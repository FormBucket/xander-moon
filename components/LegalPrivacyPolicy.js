      ...
      <div>
        <span>
          ...
          <p>
            ...
            asked to enter your email address, credit card information or other
          ...
          <p>
            To improve our website in order to better serve you. To quickly
            process your transactions. To send periodic emails regarding your
            order or other products and services. To follow up with them after
            correspondence (live chat, email or phone inquiries) How do we
          ...
          <p>
            Yes, cookies are a standard way to communicate information from
            server to browser and, vice versa. Cookies are used to transfer
            information from the server to the browser and to keep track of your
            account. Cookies assigned to the formbucket.com are marked secure,
            and can only be sent over HTTPS.
          </p>
          ...
          <h2>Intercom</h2>
          <p>This site uses Intercom to communicate with customers.</p>
          <p>
            Intercom, as a third party vendor, uses cookies on this site to
            operate their service.
          </p>
          <h2>Google</h2>
          <p>This site uses Google Analytics to track usage.</p>
          <p>
          ...
          <p>
            We have implemented the following: Demographics and Interests
          ...
          <p>
            ...
            page after entering our website. Our Privacy Policy link includes
          ...
          <p>
            ...
            Policy Page. Users are able to change their personal information: By
          ...
          <p>
            We collect your email address in order to: Send information, respond
            to inquiries, and/or other requests or questions. Process orders and
            to send information and updates pertaining to orders. We may also
            send you additional information related to your product and/or
            service. Market to our mailing list or continue to send emails to
            our clients after the original transaction has occurred.
          </p>
          <p>
            To be in accordance with CANSPAM we agree to the following: NOT use
            false or misleading subjects or email addresses. Identify the
            message as an advertisement in some reasonable way. Include the
            ...
            Honor opt-out/unsubscribe requests quickly. Allow users to
            unsubscribe by using the link at the bottom of each email.
          </p>
          <p>
            If at any time you would like to unsubscribe from receiving future
            emails, you can email us at support@formbucket.com and we will
            promptly remove you from ALL correspondence.
          </p>
          <p>Last Edited on 2018-03-01</p>
        </span>
      </div>
    </div>
  </div>
