...
let GuideMergeTags = () => (
  <Guide title="Legal" title2="General Data Protection Regulation">
    <div>
      <span>
        <p>
        ...
        <p>
          On May 25, 2018, the European Union's General Privacy Data Protection
          Regulation takes effect.
        </p>
        <p>
          In order to maintain compliance as a data controller you must obtain a
          data processing agreement (DPA) from each data processor. FormBucket
          acts a data processor. As the customer you must fulfill the
          requirements as the data controller.
        </p>
        <p>
